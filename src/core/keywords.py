"""Keyword matching with weighted scoring across 7 categories and 8 languages.

Features:
- Compound language substring matching (German, Dutch, Swedish, Danish)
...
class KeywordMatcher:
    ...
    def is_relevant(
        ...
        if url:
            ...
            result.url_bonus = self.url_bonus(url)
